...
public class UIManager : MonoBehaviour
{
    ...
    public GameObject Data_Input_Panel, Data_Update_Panel, ALL_DATA_PANEL, Create_User_Panel, Main_Panel, Camera_Panel,CamObject,Delete_Check;
    ...
    public Button CamOn_Btn, CamOff_Btn,CamShot_Btn,CamUpLoad_Btn,Cam_Retake,Friend_Delete_Btn,Delete_Check_Btn;
